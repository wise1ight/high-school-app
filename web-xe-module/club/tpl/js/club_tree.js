    ...
    $.get(url,function(data){
        ...
        simpleTreeCollection = $('.simpleTree').simpleTree({
            ...
            afterMove:function(destination, source, pos){
                ...
                $.exec_json("club.procClubMenuItemMove",{ "menu_srl":menu_srl,"parent_srl":parent_srl,"target_srl":target_srl,"source_srl":source_srl,"mode":mode},
                function(data){
                    if(data.error>0){
                        clubLoadMenuInfo(xml_url);
                    }
...
function clubAddMenu(node_srl,e) {
    ...
    jQuery.exec_json('club.getClubMenuTplInfo', params, function(data){
        jQuery('#menu_zone_info').html(data.tpl);
    });
}

function clubModifyNode(node_srl,e){
    jQuery('#menu_zone_info').html('');
    jQuery("#tree_"+node_srl+" > span").click();
...
function clubDeleteMenu(node_srl) {
